...
public class UserChangeBrancheNotification {
    ...
    public static String changeBrancheMail(String userFirstname, String userLastname, String userBranche) {
        ...
        return "<!DOCTYPE html>\n" +
                ...
                "\n" +
                "  <body>\n" +
                "    <h2 style=\"background-color:black; color: white; padding: 20px 0; margin: 0 auto;\">Branchenänderung auf KRITIS-ELFe</h2>\n" +
                "    <p>Hallo " + userFirstname + " " + userLastname + ",</p>\n" +
                "    <p>Die KRITIS-ELFe-Geschäftsstelle hat Ihnen eine neue Branche zugewiesen:</p>\n" +
